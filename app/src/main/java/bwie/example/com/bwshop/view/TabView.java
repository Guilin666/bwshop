...
public class TabView extends RelativeLayout {
    ...
    private void initTabChildView(int type) {
        ...
        if(type==0){
            ...
            mSupportFragmentManager.beginTransaction().replace(R.id.tabview_fragment_container, mFragments[mTabViewDefaultPosition]).show(mFragments[mTabViewDefaultPosition]).commit();
        }
